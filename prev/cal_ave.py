...
def print_md_inputf(file_name, nxt, window_steps):
    ...
    if nxt == 'nvt':
        ...
        print("DISANG=md_dis.RST",file=md_mdf)
...
def freeMD(prmtop, inpcrd, md_min_steps, md_nvt_steps, md_npt_steps, md_md_steps,coord_atm1_num,coord_atm2_num):
    ...
    print_md_inputf('md_min1.in', 'min1', md_min_steps)
    ...
    print_md_inputf('md_min2.in', 'min2', md_min_steps)
    ...
    print_md_inputf('md_min3.in', 'min3', md_min_steps)
    ...
    print_md_inputf('md_min4.in', 'min4', md_min_steps)
    ...
    print_md_inputf('md_min5.in', 'min5', md_min_steps)
    ...
    print_md_inputf('md_nvt.in', 'nvt', md_nvt_steps)
    ...
    print_md_inputf('md_snpt.in', 'snpt', 50000)
    os.system("mpirun -np 4 pmemd.MPI -O -i md_snpt.in -o md_snpt.out -p %s -c md_nvt.rst -r md_snpt.rst -x md_snpt.netcdf -ref md_nvt.rst" %(prmtop))
    freemd.write("mpirun -np 4 pmemd.MPI -O -i md_snpt.in -o md_snpt.out -p %s -c md_nvt.rst -r md_snpt.rst -x md_snpt.netcdf -ref md_nvt.rst\n" %(prmtop))

    #NPT
    print("Perform md_npt %d steps..." %md_npt_steps)
    print_md_inputf('md_npt.in', 'npt', md_npt_steps)
    ...
    print_md_inputf('md_md.in', 'md', md_md_steps)
...
########## NNNNNNNNNNNNNNNNNNNNNNNNNNNeed to update this for different cases!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    if abs(round(float(dat['value'][index]),2) - round(float(average),2)) > 1:
    ...
    print("trajout md_md_center_%s.rst restart"%(fram_num), file=ptrajf)
    ptrajf.close()
